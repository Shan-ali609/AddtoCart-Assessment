...
//   return (
//     <div className="container mx-auto h-screen px-4 py-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
...
//                             className="text-white text-[12px] bg-red-400 rounded-lg cursor-pointer px-2.5 py-1 text-sm mt-2"
//                           >
//                             Remove
//                           </button>
//                         </div>
...
//         <button className="w-full bg-black text-white py-3 mt-4 rounded-md hover:bg-gray-900">
//           Checkout
//         </button>
//       </div>
//     </div>
